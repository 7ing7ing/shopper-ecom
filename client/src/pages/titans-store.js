...
export default function Titans({ user }) {
  ...
  const addToWishlist = ({
    ...
    let itemIndex = titans.findIndex((item) => item.id === id);
    titans[itemIndex].liked = true;
  ...
  return (
    <div>
      ...
      />
      <h1 className="text-center p-3">ATTACK ON TITANS</h1>
