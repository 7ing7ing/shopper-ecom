...
export default function Kimetsu({ user }) {
  ...
  const addToWishlist = ({
    ...
    let itemIndex = kimetsu.findIndex((item) => item.id === id);
    kimetsu[itemIndex].liked = true;
  ...
  return (
    <div>
      <img
        ...
        alt="demon slayer"
      />
      <h1 className="text-center p-3">DEMON SLAYER</h1>
