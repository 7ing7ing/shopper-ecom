...
export default function OnePiece({ user }) {
  ...
  const addToWishlist = ({
    ...
    let itemIndex = onepiece.findIndex((item) => item.id === id);
    onepiece[itemIndex].liked = true;
  ...
  const removeFromWishlist = (id) => {
    let itemIndex = onepiece.findIndex((item) => item.id === id);
    onepiece[itemIndex].liked = false;
    dispatch({
  ...
  return (
    <div>
      <img
        ...
        alt="one piece"
      />
      <h1 className="text-center p-3">ONE PIECE</h1>
